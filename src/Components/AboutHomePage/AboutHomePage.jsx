    ...
    <section className='about-section w-full'>
      <div className=' about-container max-w-[1920px] m-[0 auto] px-[10px] py-[40px] flex justify-center items-center'>
        ...
        <div className='same-col w-[48%] flex flex-col items-start gap-3'>
            <span className=' font-light'>HATTON GARDEN JEWELLERS</span>
            <h3 className=' font-bold text-xl'>Crafted With Love, For Love</h3>
            <p className=' font-light text-lg'>At Harper Tait, love means everything. In the heart of Hatton Garden we craft beautiful fine jewellery with exceptional attention to detail; a celebration of what matters most.</p>
            ...
            <a href="" className=' px-3 py-1 font-bold bg-[#FDDFEE]'>FIND OUT MORE</a>
        </div>
      </div>
    </section>
  )
